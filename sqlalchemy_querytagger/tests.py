...
class SelectableTaggedClauseElementTest(unittest.TestCase):
    def _getTarget(self):
        from .expression import SelectableTaggedClauseElement
        return SelectableTaggedClauseElement
...
class TaggerQueryTest(unittest.TestCase):
    def _getTarget(self):
        from .orm import TaggerQuery
        return TaggerQuery
    ...
    def test_it(self):
        ...
        from .orm import SessionFactoryFactory, TaggerQuery
